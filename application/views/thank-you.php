...
<div id="carousel" class="carousel slide home-slider" data-ride="carousel">
    <div class="carousel-inner">
        ...
        {
            ?>
             <div class="active item fadeInRight animated" style="background: url(<?=base_url('thankyou-images/all.jpg');?>);height: 268px;"></div>
            <?php
        }
        }
        ?>
...
<div class="container">
 ...
 -->        <h3 class="thank_head">Thank you for your interest<?= ($this->input->get('title')) ? ' in '.$this->input->get('title').'!' : '!' ?></h3>
        <div class="th2">
            For immediate Assistance  <span class="phoneno"><a href="tel:+919019000400" style="text-decoration:none;color:#333">+919019000400</a></span>
        </div>
    </div>
</div>
<?php
