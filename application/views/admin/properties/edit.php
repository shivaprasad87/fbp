...
<?php //print_r($faq); echo $faq[0]->question;die; ?>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="form-group">
                            <label class="control-label" for="usp">Question</label>
                            <div class=" <?= form_error('usp') ? 'has-error' : '' ?>">
                                <textarea id="usp" class="form-control"
                                name="FQ[<?=$i?>]"><?=$faq[$i]->question?></textarea>
                            </div>
                        </div>
            </div> 
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="form-group">
                    <label class="control-label" for="usp">Answer</label>
                    <div class=" <?= form_error('usp') ? 'has-error' : '' ?>">
                        <textarea id="usp" class="form-control"
                        name="FA[<?=$i?>]"><?=$faq[$i]->answer?></textarea>
                    </div>
                </div>
            </div> 
            <br> 
